...
CANDIDATES = {
    ...
    "陳素月": {
        ...
        "relevant_check": (
            ...
            "【重要】台灣有兩位陳素月：\n"
            "1. 本系統監控：立法委員陳素月（彰化縣第4選區）\n"
            "2. 不相關：員林市長陳素月（彰化縣員林市）\n\n"
            "relevant=TRUE（必須符合其中一項）：\n"
            "- 明確用「立委陳素月」「彰化縣長候選人」\n"
            "- 立法院質詢、交通委員會、彰化縣4選區\n"
            "- 2026彰化縣長選舉直接相關\n\n"
            "relevant=FALSE（以下任一即為false，不得例外）：\n"
            "- 白米、包材、農產包材、農會、稻米、自備袋買米 → 員林農會業務\n"
            "- 員林市、員林市長、員林農會、大峦巫步道、北溝排水 → 員林市長業務\n"
            "- 八卦山、步道、環保考察、樂齊老人、長照 → 地方活動\n"
