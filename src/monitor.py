...
CANDIDATES = {
    ...
    "陳素月": {
        ...
        "relevant_check": (
            "本系統監控的是【立法委陳素月】，彰化縣第4選區，2026彰化縣長候選人。\n"
            "主要職務：立法院交通委員會、彰化地方建設等争取、教育資源。\n\n"
            "【絕對白名單－一律 relevant=true】\n"
            "帳號含 SayYes 或陳素月委員的貣文 → 立委本人帳號，不管內容\n\n"
            "relevant=TRUE（必須符合其中一項）：\n"
            "- 明確含「立委陳素月」「彰化縣長候選人」\n"
            "- 立法院質詢、交通委員會、彰化縣4選區\n"
            "- 2026彰化縣長選舉直接相關\n"
            "- 強連候選人動態（如謝衣鳳等）直接影響彰化縣長選戰格局 → relevant=true\n\n"
            "relevant=FALSE（以下任一即為false）：\n"
            "- 白米、包材、農產包材、農會、稻米、自備袋 → 員林農會\n"
            "- 員林市、員林市長、員林地方建設 → 員林市長\n"
            "- 八卦山、步道、環保考察、媒祖、宗教活動\n"
